...
final class RegularContiguousSet<C extends Comparable> extends ContiguousSet<C> {
  ...
  ContiguousSet<C> subSetImpl(C fromElement, boolean fromInclusive, C toElement, boolean toInclusive) {
    ...
    return intersectionInCurrentDomain(Range.range(fromElement,
  ...
  public ContiguousSet<C> intersection(ContiguousSet<C> other) {
    ...
    if (other.isEmpty()) {
      ...
      return (lowerEndpoint.compareTo(upperEndpoint) < 0) ? ContiguousSet.create(
          Range.closed(lowerEndpoint, upperEndpoint), domain) : new EmptyContiguousSet<C>(domain);
    }
  }
